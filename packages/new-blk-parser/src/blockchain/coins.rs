...
pub struct B1TCore;
impl Coin for B1TCore {
    const NAME: &'static str = "B1TCore";
    const CONFIG: EncoderConfig = EncoderConfig {
        pubkey_address: 25,
        script_address: 22,
        bech32: "b1t",
...
pub struct B1TCoreTestnet;
impl Coin for B1TCoreTestnet {
    const NAME: &'static str = "B1TCore Testnet";
    const CONFIG: EncoderConfig = EncoderConfig {
        pubkey_address: 65,
        script_address: 196,
        bech32: "tb1t",
...
impl FromStr for CoinType {
    ...
    fn from_str(coin_name: &str) -> Result<Self> {
        match coin_name {
            ...
            "b1tcore" => Ok(CoinType::from(B1TCore)),
            "b1tcore-testnet" => Ok(CoinType::from(B1TCoreTestnet)),
